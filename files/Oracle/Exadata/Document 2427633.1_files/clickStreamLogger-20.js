...
var XMLHttpArray = [
        ...
        function() {return CSCO_WebVPN["newactivex"]("Msxml2.XMLHTTP")},
        function() {return CSCO_WebVPN["newactivex"]("Msxml2.XMLHTTP")},
        function() {return CSCO_WebVPN["newactivex"]("Microsoft.XMLHTTP")}
];
...
//            callback(req);
//    }
    CSCOCall_open(req,"open",'GET',postUrl,true);
...
function getUrl(){
    var portalPath = CSCOGet_pathname(CSCOGet_location(window));

...
select snap_id "snap",inst "inst",
  ...
  max(decode(stat_name,'bytes received via SQL*Net from client', value,null)) "sqlnet_bytes_received_from_client",
  max(decode(stat_name,'bytes sent via SQL*Net to client',       value,null)) "sqlnet_bytes_sent_to_client",
  max(decode(stat_name,'bytes via SQL*Net vector from client',   value,null)) "sqlnet_bytes_vector_from_client",
  max(decode(stat_name,'bytes via SQL*Net vector to client',     value,null)) "sqlnet_bytes_vector_to_client"
  from(
